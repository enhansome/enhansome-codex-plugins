...
1. **Validate with [`plugin-scanner`](https://github.com/hashgraph-online/hol-guard) ⭐ 575 | 🐛 46 | 🌐 Python | 📅 2026-09-09** — **Required: score ≥ 80, no high/critical findings**
2. **Gate PRs with the [HOL scanner GitHub Action](https://github.com/hashgraph-online/ai-plugin-scanner-action) ⭐ 5 | 🐛 1 | 📅 2026-09-09** — **Required for listing**
...
* [Claude Code Skills](https://github.com/alirezarezvani/claude-skills) ⭐ 25,742 | 🐛 14 | 🌐 Python | 📅 2026-08-30 - 223 production-ready skills, 23 agents, and 298 Python tools across 9 domains — engineering, marketing, product, compliance, and more.
* [Generative Media Skills](https://github.com/SamurAIGPT/Generative-Media-Skills) ⭐ 4,254 | 🐛 3 | 🌐 Shell | 📅 2026-09-08 - 13 skills for image, video, and audio generation using 100+ models - FLUX, Midjourney v7, Veo3, Kling 3.0, Suno, and HunyuanVideo via muapi.ai.
...
* [Brooks Lint](https://github.com/hyhmrright/brooks-lint) ⭐ 1,459 | 🐛 1 | 🌐 JavaScript | 📅 2026-09-07 - AI code reviews grounded in six classic engineering books — decay risk diagnostics with book citations, severity labels, and four analysis modes (PR review, architecture audit, tech debt, test quality).
...
* [Aegis](https://github.com/GanyuanRan/Aegis) ⭐ 1,176 | 🐛 1 | 🌐 Python | 📅 2026-09-07 - An agentic skills framework & software development methodology that works: planning, TDD, debugging, and collaboration workflows.
* [spec-superflow](https://github.com/MageByte-Zero/spec-superflow) ⭐ 793 | 🐛 7 | 🌐 JavaScript | 📅 2026-09-02 - Spec-first workflow with nine skills, lightweight Quick / Hotfix / Tweak / Full paths, bounded three-attempt repair loops with auditable adjudication recovery, hardened delta-spec sync, and guarded review gates.
...
* [token-optimizer](https://github.com/ooples/token-optimizer-mcp) ⭐ 509 | 🐛 4 | 🌐 JavaScript | 📅 2026-09-09 - Cut token usage 60-90% with caching, compression, and smart file tools — diff-only re-reads, paths-only search, out-of-context stashing, and a per-tool savings report for Codex and Claude Code.
* [Codex Multi Auth](https://github.com/ndycode/codex-multi-auth) ⭐ 482 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-08 - Multi-account OAuth manager for the official Codex CLI with switching, health checks, and recovery tools.
* [AgentOps](https://github.com/boshu2/agentops) ⭐ 434 | 🐛 2 | 🌐 Go | 📅 2026-09-09 - DevOps layer for coding agents with flow, feedback, and memory that compounds between sessions.
...
* [Nightshift](https://github.com/orwa-mahmoud/nightshift) ⭐ 58 | 🐛 4 | 🌐 Shell | 📅 2026-09-08 - Accountable, time-bounded Codex shifts with a persistent punch list, parked decisions, and reviewable run history.
...
* [memi](https://github.com/sarveshsea/memi) ⭐ 40 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-08 - Interface understanding and design-system memory for Codex, Claude Code, Cursor, and MCP agents with UI audits, Tailwind token extraction, shadcn registry workflows, and a bundled Codex plugin.
* [Click](https://github.com/grapefruit0205/click) ⭐ 39 | 🐛 0 | 🌐 Python | 📅 2026-09-09 - Turn software intent into one approved contract, then let AI build and verify in one shot—with traceable evidence for each requirement.
...
* [Agent Guard](https://github.com/JeongJaeSoon/agent-guard) ⭐ 26 | 🐛 6 | 🌐 Shell | 📅 2026-09-09 - Local-by-default, no-telemetry hooks block or mask secret leaks in Claude Code and Codex, with opt-in PII filtering and Git/CI backstops.
...
* [UIZZE](https://github.com/uizze/uizze) ⭐ 19 | 🐛 5 | 🌐 JavaScript | 📅 2026-09-09 - STOP UI SLOP. Gives Codex 800,000+ real web and iOS screens, a product-specific design contract, and a hard finish gate before generic UI ships; connect it at <https://uizze.com>.
...
* [Runtype Skills](https://github.com/runtypelabs/skills) ⭐ 1 | 🐛 1 | 🌐 JavaScript | 📅 2026-09-09 - Supercharge your coding agent for AI product development — build, deploy, and operate agents, flows, tools, and surfaces on Runtype's managed edge runtime.
...
* [LinkedIn Skills](https://github.com/sergebulaev/linkedin-skills) ⭐ 1,359 | 🐛 1 | 🌐 Python | 📅 2026-09-09 - Codex-ready LinkedIn marketing bundle with a native .codex-plugin manifest and 10 skills: post writing with 16 tested hook formulas, AI-tell humanizer, pre-publish audit, comment and reply drafting, hook extraction, content planning, profile optimization, engager analytics, and thread monitoring; also works in Claude Code.
* [KiCad Happy](https://github.com/aklofas/kicad-happy) ⭐ 1,162 | 🐛 2 | 🌐 Python | 📅 2026-09-01 - KiCad EDA skills for schematic analysis, PCB layout review, component sourcing, BOM management, and manufacturing preparation.
* [YouTube Skills by TranscriptAPI](https://github.com/ZeroPointRepo/youtube-skills) ⭐ 835 | 🐛 4 | 📅 2026-09-08 - Twelve drop-in agent skills for YouTube transcripts, timestamped captions and subtitles, video and channel search, playlists and channel browsing through the TranscriptAPI service.
...
* [deja](https://github.com/vshulcz/deja-vu) ⭐ 795 | 🐛 110 | 🌐 Go | 📅 2026-09-09 - Search the coding sessions already on your disk — Codex, Claude Code, Cursor, opencode and nineteen more — including work from before it was installed, indexed locally with no model in the loop.
...
* [ru-text](https://github.com/talkstream/ru-text) ⭐ 226 | 🐛 0 | 🌐 Shell | 📅 2026-08-28 - Russian text quality — \~1,044 rules for typography, info-style, editorial, UX writing, and business correspondence.
...
* [unslop](https://github.com/MohamedAbdallah-14/unslop) ⭐ 131 | 🐛 1 | 🌐 Python | 📅 2026-09-07 - Strip AI writing patterns from text output — removes filler phrases, hedging language, and generic constructs to produce cleaner written content. Install: `npm install -g unslop`.
...
* [Call-E](https://github.com/CALLE-AI/call-e-integrations) ⭐ 91 | 🐛 20 | 🌐 JavaScript | 📅 2026-09-08 - Plan, run, and inspect Call-E phone call workflows from Codex through the calle CLI.
...
* [X (Twitter) Skills](https://github.com/sergebulaev/x-skills) ⭐ 64 | 🐛 0 | 🌐 Python | 📅 2026-09-09 - Codex-ready X (Twitter) marketing bundle with a native .codex-plugin manifest: tweet and thread writing with corpus-validated hook formulas (validated against \~450 top tweets), AI-tell humanizer, hook extraction, reply drafting, content planning, and audience insights; also works in Claude Code.
...
After scaffolding with `$plugin-creator`, use [`plugin-scanner`](https://github.com/hashgraph-online/hol-guard) ⭐ 575 | 🐛 46 | 🌐 Python | 📅 2026-09-09 as your quality gate before publishing, review, or distribution.
...
* [Tura](https://github.com/Tura-AI/tura) ⭐ 620 | 🐛 3 | 🌐 Rust | 📅 2026-08-20 - A local, open-source coding agent for developers who are tired of vague skill claims, token-saving extensions with no evidence, and agents that change a repository before understanding it.
* [awesome-ai-plugins](https://github.com/hashgraph-online/awesome-ai-plugins) ⭐ 214 | 🐛 42 | 🌐 Python | 📅 2026-09-09 - Umbrella list covering Codex, Claude Code, Gemini CLI, and MCP servers.
* [codex-patch-overlay](https://github.com/salty-flower/codex-patch-overlay) ⭐ 0 | 🐛 1 | 🌐 Nushell | 📅 2026-09-09 - Patched Codex CLI builds carrying community-requested features upstream has not merged yet (live TUI reasoning streaming, completion sound, WebP image input, timed CLI queueing). Ready-to-run macOS/Linux binaries plus a Nix overlay, refreshed each upstream release.
...
Every plugin in this list is automatically ingested by the [HOL Plugin Registry](https://hol.org/registry/plugins), which runs each through the [`plugin-scanner`](https://github.com/hashgraph-online/hol-guard) ⭐ 575 | 🐛 46 | 🌐 Python | 📅 2026-09-09 to produce a trust score and security analysis.
