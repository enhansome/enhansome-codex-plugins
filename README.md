...
1. **Validate with [`plugin-scanner`](https://github.com/hashgraph-online/hol-guard) ⭐ 539 | 🐛 38 | 🌐 Python | 📅 2026-09-04** — **Required: score ≥ 80, no high/critical findings**
...
* [Claude Code Skills](https://github.com/alirezarezvani/claude-skills) ⭐ 25,505 | 🐛 11 | 🌐 Python | 📅 2026-08-30 - 223 production-ready skills, 23 agents, and 298 Python tools across 9 domains — engineering, marketing, product, compliance, and more.
* [Generative Media Skills](https://github.com/SamurAIGPT/Generative-Media-Skills) ⭐ 4,216 | 🐛 3 | 🌐 Shell | 📅 2026-08-27 - 13 skills for image, video, and audio generation using 100+ models - FLUX, Midjourney v7, Veo3, Kling 3.0, Suno, and HunyuanVideo via muapi.ai.
* [Claude Octopus](https://github.com/nyldn/claude-octopus) ⭐ 4,041 | 🐛 15 | 🌐 Shell | 📅 2026-09-04 - Multi-LLM orchestration dispatching to 8 providers (Codex, Gemini, Copilot, Qwen, Perplexity, OpenRouter, Ollama, OpenCode) with Double Diamond workflows, adversarial review, and safety gates.
...
* [Aegis](https://github.com/GanyuanRan/Aegis) ⭐ 1,167 | 🐛 3 | 🌐 Python | 📅 2026-09-03 - An agentic skills framework & software development methodology that works: planning, TDD, debugging, and collaboration workflows.
...
* [token-optimizer](https://github.com/ooples/token-optimizer-mcp) ⭐ 507 | 🐛 7 | 🌐 JavaScript | 📅 2026-09-03 - Cut token usage 60-90% with caching, compression, and smart file tools — diff-only re-reads, paths-only search, out-of-context stashing, and a per-tool savings report for Codex and Claude Code.
...
* [Nightshift](https://github.com/orwa-mahmoud/nightshift) ⭐ 51 | 🐛 4 | 🌐 Shell | 📅 2026-09-02 - Accountable, time-bounded Codex shifts with a persistent punch list, parked decisions, and reviewable run history.
...
* [Quality Engineering Skills](https://github.com/RBraga01/Quality-Engineering-Skills) ⭐ 27 | 🐛 2 | 🌐 JavaScript | 📅 2026-08-28 - 22 structured quality engineering skills for automotive and manufacturing: ISO 9001, IATF 16949, AIAG-VDA FMEA, VDA 6.3, PPAP, APQP, SPC, MSA.
...
* [River Review](https://github.com/s977043/river-review) ⭐ 3 | 🐛 22 | 🌐 JavaScript | 📅 2026-09-04 - Versioned Skill Registry of code-review skills driven by a perspective-based review agent (code, security, performance, architecture, testing, adversarial) that verifies findings against the diff.
...
* [KiCad Happy](https://github.com/aklofas/kicad-happy) ⭐ 1,090 | 🐛 1 | 🌐 Python | 📅 2026-09-01 - KiCad EDA skills for schematic analysis, PCB layout review, component sourcing, BOM management, and manufacturing preparation.
* [LinkedIn Skills](https://github.com/sergebulaev/linkedin-skills) ⭐ 838 | 🐛 2 | 🌐 Python | 📅 2026-09-03 - Codex-ready LinkedIn marketing bundle with a native .codex-plugin manifest and 10 skills: post writing with 16 tested hook formulas, AI-tell humanizer, pre-publish audit, comment and reply drafting, hook extraction, content planning, profile optimization, engager analytics, and thread monitoring; also works in Claude Code.
...
* [YouTube Skills by TranscriptAPI](https://github.com/ZeroPointRepo/youtube-skills) ⭐ 695 | 🐛 3 | 📅 2026-09-01 - Twelve drop-in agent skills for YouTube transcripts, timestamped captions and subtitles, video and channel search, playlists and channel browsing through the TranscriptAPI service.
...
* [OC ChatGPT Multi Auth](https://github.com/ndycode/oc-chatgpt-multi-auth) ⭐ 185 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-03 - Codex setup skill and OpenCode plugin for ChatGPT Plus/Pro OAuth, GPT-5/Codex presets, and multi-account failover.
...
After scaffolding with `$plugin-creator`, use [`plugin-scanner`](https://github.com/hashgraph-online/hol-guard) ⭐ 539 | 🐛 38 | 🌐 Python | 📅 2026-09-04 as your quality gate before publishing, review, or distribution.
...
* [awesome-ai-plugins](https://github.com/hashgraph-online/awesome-ai-plugins) ⭐ 161 | 🐛 21 | 🌐 Python | 📅 2026-09-03 - Umbrella list covering Codex, Claude Code, Gemini CLI, and MCP servers.
...
Every plugin in this list is automatically ingested by the [HOL Plugin Registry](https://hol.org/registry/plugins), which runs each through the [`plugin-scanner`](https://github.com/hashgraph-online/hol-guard) ⭐ 539 | 🐛 38 | 🌐 Python | 📅 2026-09-04 to produce a trust score and security analysis.
