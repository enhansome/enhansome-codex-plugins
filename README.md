...
1. **Validate with [`plugin-scanner`](https://github.com/hashgraph-online/hol-guard) ⭐ 666 | 🐛 117 | 🌐 Python | 📅 2026-09-25**. The catalog-owned centralized scan must report a numeric score ≥ 80 before merge.
2. **Optionally gate your source repo with the [HOL scanner GitHub Action](https://github.com/hashgraph-online/ai-plugin-scanner-action) ⭐ 5 | 🐛 1 | 📅 2026-09-24**. Catalog admission uses the centralized scan; source-repo scanner CI is recommended but not required.
...
* [Claude Code Skills](https://github.com/alirezarezvani/claude-skills) ⭐ 26,436 | 🐛 26 | 🌐 Python | 📅 2026-08-30 - 223 production-ready skills, 23 agents, and 298 Python tools across 9 domains — engineering, marketing, product, compliance, and more.
* [Generative Media Skills](https://github.com/SamurAIGPT/Generative-Media-Skills) ⭐ 4,326 | 🐛 4 | 🌐 Shell | 📅 2026-09-08 - 13 skills for image, video, and audio generation using 100+ models - FLUX, Midjourney v7, Veo3, Kling 3.0, Suno, and HunyuanVideo via muapi.ai.
...
* [Stop That Shit](https://github.com/lennney/stop-that-shit) ⭐ 2,267 | 🐛 4 | 🌐 JavaScript | 📅 2026-09-24 - Local-first scope guard for Codex with explicit task modes, before-action checks, and bounded dependency, hash, and subagent decisions.
* [Brooks Lint](https://github.com/hyhmrright/brooks-lint) ⭐ 1,495 | 🐛 0 | 🌐 HTML | 📅 2026-09-21 - AI code reviews grounded in six classic engineering books — decay risk diagnostics with book citations, severity labels, and four analysis modes (PR review, architecture audit, tech debt, test quality).
...
* [Aegis](https://github.com/GanyuanRan/Aegis) ⭐ 1,281 | 🐛 0 | 🌐 Python | 📅 2026-09-24 - An agentic skills framework & software development methodology that works: planning, TDD, debugging, and collaboration workflows.
* [spec-superflow](https://github.com/MageByte-Zero/spec-superflow) ⭐ 821 | 🐛 4 | 🌐 JavaScript | 📅 2026-09-24 - Lean spec workflow with direct or planned execution, optional specifications, one final review by default, recoverable state, and a bundled same-version CLI runtime.
...
* [token-optimizer](https://github.com/ooples/token-optimizer-mcp) ⭐ 536 | 🐛 14 | 🌐 JavaScript | 📅 2026-09-23 - Cut token usage 60-90% with caching, compression, and smart file tools — diff-only re-reads, paths-only search, out-of-context stashing, and a per-tool savings report for Codex and Claude Code.
* [Codex Multi Auth](https://github.com/ndycode/codex-multi-auth) ⭐ 516 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-25 - Multi-account OAuth manager for the official Codex CLI with switching, health checks, and recovery tools.
* [AgentOps](https://github.com/boshu2/agentops) ⭐ 445 | 🐛 1 | 🌐 Go | 📅 2026-09-25 - DevOps layer for coding agents with flow, feedback, and memory that compounds between sessions.
...
* [Emulo](https://github.com/ohad6k/emulo) ⭐ 292 | 🐛 14 | 🌐 HTML | 📅 2026-09-25 - Mines selected evidence from local coding-agent sessions into private work, design, and writing profiles for Codex, Claude Code, and GitHub Copilot.
...
* [Nightshift](https://github.com/orwa-mahmoud/nightshift) ⭐ 66 | 🐛 4 | 🌐 Shell | 📅 2026-09-25 - Accountable, time-bounded Codex shifts with a persistent punch list, parked decisions, and reviewable run history.
* [Archcore](https://github.com/archcore-ai/archcore) ⭐ 63 | 🐛 16 | 🌐 Shell | 📅 2026-09-24 - Spec-driven development and context engineering for Claude Code, Cursor, Codex, and GitHub Copilot — backed by project context in Git.
...
* [Waggle](https://github.com/Abhigyan-Shekhar/Waggle-mcp) ⭐ 43 | 🐛 210 | 🌐 Python | 📅 2026-09-25 - Persistent graph-backed conversational memory for Codex that recalls project decisions, constraints, preferences, and outcomes across sessions.
...
* [Click](https://github.com/grapefruit0205/click) ⭐ 41 | 🐛 6 | 🌐 Python | 📅 2026-09-24 - Turn software intent into one approved contract, then let AI build and verify in one shot—with traceable evidence for each requirement.
...
* [Vibe Prospecting](https://github.com/explorium-ai/vibeprospecting-plugin) ⭐ 40 | 🐛 4 | 🌐 Shell | 📅 2026-09-24 - Live B2B company and contact intelligence for building lead lists, researching prospects, enriching contacts, and personalizing outreach.
...
* [Quality Engineering Skills](https://github.com/RBraga01/Quality-Engineering-Skills) ⭐ 36 | 🐛 2 | 🌐 JavaScript | 📅 2026-09-21 - 22 structured quality engineering skills for automotive and manufacturing: ISO 9001, IATF 16949, AIAG-VDA FMEA, VDA 6.3, PPAP, APQP, SPC, MSA.
...
* [Agent Guard](https://github.com/JeongJaeSoon/agent-guard) ⭐ 30 | 🐛 1 | 🌐 Shell | 📅 2026-09-25 - Local-by-default, no-telemetry hooks block or mask secret leaks in Claude Code and Codex, with opt-in PII filtering and Git/CI backstops.
...
* [Goal Progress](https://github.com/ezra-y/codex-goal-progress) ⭐ 27 | 🐛 12 | 🌐 TypeScript | 📅 2026-09-22 - A native progress bar for Codex Goals with checklist-based progress and token usage on Apple Silicon Macs.
...
* [UIZZE](https://github.com/uizze/uizze) ⭐ 26 | 🐛 4 | 🌐 JavaScript | 📅 2026-09-21 - STOP UI SLOP. Gives Codex 800,000+ real web and iOS screens, a product-specific design contract, and a hard finish gate before generic UI ships; connect it at <https://uizze.com>.
...
* [Epic Harness](https://github.com/epicsagas/epic-harness) ⭐ 20 | 🐛 6 | 🌐 Rust | 📅 2026-09-24 - Auto-trigger quality skills + self-evolving agent harness — orbit (spec-to-ship), evolve (skill mutation), team (multi-agent), TDD, check, ship, simplify, debug, perf, secure.
...
* [Quiver](https://github.com/yagizdo/quiver) ⭐ 14 | 🐛 1 | 🌐 Shell | 📅 2026-09-21 - 21 development lifecycle skills and 20 review and debug agents for Codex, Claude Code, Cursor, and OpenCode, where every step writes its output to disk instead of leaving it in the chat.
...
* [Kernel](https://github.com/ariaxhan/kernel-claude) ⭐ 13 | 🐛 9 | 🌐 Python | 📅 2026-09-25 - Hook-enforced guardrails for Codex and Claude Code with blocked destructive commands, one-time human tokens for irreversible operations, context-blind verification agents, and SQLite agent memory recalled at session start.
...
* [Simple Man](https://github.com/Maksim-Burtsev/simple-man) ⭐ 11 | 🐛 1 | 🌐 Python | 📅 2026-09-01 - Strips praise, recaps and filler from agent answers while keeping every fact you act on — findings carry location and one-line fix, refusals carry the safe procedure, tutorials stay long-form — benchmarked on 2,479 preregistered live calls, 266 of them real Claude Code sessions, with all raw records committed.
...
* [Claudemon](https://github.com/OriginalName457/claudemon) ⭐ 8 | 🐛 2 | 🌐 JavaScript | 📅 2026-09-20 - Turns your coding agents into pixel creatures you can watch work and collect, with a built-in Clawland .io brawler for breaks.
...
* [Magents](https://github.com/abnegate/magents) ⭐ 6 | 🐛 2 | 🌐 Rust | 📅 2026-09-22 - Shared session bus MCP + skill so Codex can list, read, hand off, send, and spawn with Claude, Cursor, Grok, and friends without pasting context.
...
* [DevRecap](https://github.com/jquinteiroo/devrecap) ⭐ 4 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-23 - Reconstruct evidence-backed developer work from authorized Codex and Claude history plus read-only Git, then turn it into daily standups, weekly reviews, sprint recaps, and memory reports.
...
* [Codex Quota Optimizer](https://github.com/ctdaniel/codex-quota-optimizer) ⭐ 3 | 🐛 0 | 🌐 Python | 📅 2026-09-22 - Reduces avoidable Codex usage with task-aware model routing, focused context, minimal change surfaces, and layered verification.
...
* [Herdr Codex Subagents](https://github.com/arvkonstantin/herdr-codex-subagents) ⭐ 3 | 🐛 0 | 🌐 Python | 📅 2026-09-21 - Opens a read-only Herdr pane for every Codex subagent and closes it when the work is done.
...
* [Codex Tasklist](https://github.com/martinille/codex-tasklist) ⭐ 2 | 🐛 0 | 🌐 Python | 📅 2026-09-19 - A persistent per-session task list for Codex CLI with a live, scrollable panel across terminals through native integrations or a launcher with tmux fallback.
...
* [Core Learning](https://github.com/everclear077/codex-learning-plugin) ⭐ 2 | 🐛 1 | 🌐 Python | 📅 2026-09-13 - Guided learning with Socratic practice, Feynman teach-back, spaced recall, evidence-based project assessment, and optional local Anki export.
...
* [AtomLane](https://github.com/cloudguo123/atomlane) ⭐ 1 | 🐛 4 | 🌐 Python | 📅 2026-09-21 - Parallelizes only work proven safe by compiling resource-aware atomic plans for builds, tests, Make/Compose workflows, and long-running jobs with live progress and measured savings.
...
* [DeepSeek Mini-Router](https://github.com/hccccc01333/codex-deepseek-mini-router) ⭐ 1 | 🐛 2 | 🌐 JavaScript | 📅 2026-09-20 - Task-aware spec/react/flash working-contract plugin that fixes DeepSeek weak default reasoning inside Codex, with a measured BigCodeBench harness included.
...
* [Rekall](https://github.com/DitriXNew/rekall) ⭐ 1 | 🐛 3 | 🌐 JavaScript | 📅 2026-09-20 - Deliberate context compaction within a single Codex thread on the VS Code extension, with a verified task handoff and one-time automatic continuation.
...
* [TNT House Risk-Data API](https://github.com/menantonio83-hue/codex-plugin-tnt-risk-api) ⭐ 1 | 🐛 1 | 📅 2026-08-21 - Solana token risk scoring for AI trading agents via MCP: safety score, insider wallet cluster detection, mint/freeze authority, honeypot risk, and LP-lock status in one call.
...
* [Devin Plugin CC](https://github.com/TheOnlyFusionCube/devin-plugin-cc) ⭐ 0 | 🐛 3 | 🌐 JavaScript | 📅 2026-09-24 - Devin AI code reviews, delegated tasks, Fusion lead/sidekick workflows, and cloud handoffs to app.devin.ai for Codex, Claude Code, and other coding agents.
* [Markdown Reader](https://github.com/JoseEstevez520/mcp-md-reader) ⭐ 0 | 🐛 7 | 🌐 JavaScript | 📅 2026-09-20 - Navigate Markdown structure and retrieve only the relevant section through a portable Codex MCP plugin.
* [ML Pipeline](https://github.com/jananthan30/ml-pipeline) ⭐ 0 | 🐛 2 | 🌐 Python | 📅 2026-09-23 - Enforces a strict 16-step data-first ML workflow — data inspection, EDA, and problem definition before any model training — with explicit user-permission gates, marimo notebooks, and matplotlib figures at every step; also works in Claude Code and Kimi.
...
* [LinkedIn Skills](https://github.com/sergebulaev/linkedin-skills) ⭐ 3,467 | 🐛 4 | 🌐 Python | 📅 2026-09-23 - Codex-ready LinkedIn marketing bundle with a native .codex-plugin manifest and 10 skills: post writing with 16 tested hook formulas, AI-tell humanizer, pre-publish audit, comment and reply drafting, hook extraction, content planning, profile optimization, engager analytics, and thread monitoring; also works in Claude Code.
* [KiCad Happy](https://github.com/aklofas/kicad-happy) ⭐ 1,291 | 🐛 2 | 🌐 Python | 📅 2026-09-13 - KiCad EDA skills for schematic analysis, PCB layout review, component sourcing, BOM management, and manufacturing preparation.
* [deja](https://github.com/vshulcz/deja-vu) ⭐ 995 | 🐛 16 | 🌐 Go | 📅 2026-09-25 - Search the coding sessions already on your disk — Codex, Claude Code, Cursor, opencode and nineteen more — including work from before it was installed, indexed locally with no model in the loop.
* [YouTube Skills by TranscriptAPI](https://github.com/ZeroPointRepo/youtube-skills) ⭐ 958 | 🐛 4 | 📅 2026-09-22 - Twelve drop-in agent skills for YouTube transcripts, timestamped captions and subtitles, video and channel search, playlists and channel browsing through the TranscriptAPI service.
...
* [Education Agent Skills](https://github.com/GarethManning/education-agent-skills) ⭐ 801 | 🐛 3 | 🌐 TypeScript | 📅 2026-08-28 - 131 evidence-based education skills for curriculum design, lesson planning, and assessment, with transparent evidence ratings and MCP server.
* [Story Skills](https://github.com/danjdewhurst/story-skills) ⭐ 243 | 🐛 1 | 🌐 JavaScript | 📅 2026-09-25 - Fiction-writing skills for planning, drafting, and revising stories as markdown, with a dependency-free CLI that checks continuity: deaths, promise payoffs, open questions, and durable story state.
...
* [Langfuse Observability](https://github.com/avivsinai/langfuse-mcp) ⭐ 106 | 🐛 2 | 🌐 Python | 📅 2026-09-25 - Query traces, debug exceptions, analyze sessions, and manage prompts via MCP tools.
...
* [Fantasy Football Manager](https://github.com/krmisystems/fantasy-football-manager) ⭐ 91 | 🐛 0 | 🌐 Python | 📅 2026-09-24 - Manage ESPN fantasy drafts and season transactions with configurable approval limits and a multi-team portfolio dashboard.
...
* [Jev Social](https://github.com/socai-io/jev-social) ⭐ 79 | 🐛 3 | 🌐 JavaScript | 📅 2026-09-25 - Read-only Instagram, TikTok, and LinkedIn research in the user's Chrome, with Jev selecting bounded operations and the socai CLI streaming posts, comments, video evidence, and source-linked reports.
...
* [BurpSuite MCP Bridge](https://github.com/6jeffr3y/burpsuite-mcp-bridge) ⭐ 4 | 🐛 5 | 🌐 Python | 📅 2026-09-21 - Bridge Burp Suite traffic, replay, rewrite rules, and evidence export into Codex through MCP for WSL, Windows, and macOS workflows.
...
* [Qatom](https://github.com/TODAQmicro/qatom-skill) ⭐ 3 | 🐛 1 | 🌐 Python | 📅 2026-09-18 - An MCP agentic commerce market. One-step register your MCP server. Build your API & services catalog. Sell with your own merchant agent. Customers, agents, and consumers discover and purchase from your catalog. Control your own payments, auditable records, payouts to supply chain and bank.
* [WaveSpeed](https://github.com/WaveSpeedAI/codex-plugin-wavespeed-cli) ⭐ 3 | 🐛 0 | 🌐 Shell | 📅 2026-09-05 - Generate and edit AI images, video, audio, and 3D on the WaveSpeed platform with a bundled MCP server and CLI skill, including live catalog search, local-file upload, and price quotes before running.
...
* [AgentGuards](https://github.com/alelaguard/agentguards-plugins) ⭐ 1 | 🐛 0 | 🌐 Python | 📅 2026-09-25 - LLM security guardrails for Codex with enforcing hooks and MCP tools: jailbreak and prompt-injection detection, web-content scanning, data-exfiltration blocking, and destructive-command authorization.
* [Command Code Usage](https://github.com/Jovan1666/commandcode-usage) ⭐ 1 | 🐛 4 | 🌐 JavaScript | 📅 2026-09-24 - Show your Command Code plan usage inside Codex: a per-turn quota line, plus a /quota command for the full panel.
...
* [Build Remote Agent](https://github.com/LinespottingOrg/GrokBuildRemote-Agents) ⭐ 0 | 🐛 4 | 🌐 Go | 📅 2026-09-22 - Pair a phone as spectator to a local Codex session via gbr-agent (QR / 8-char) and attach at 127.0.0.1:8788 or gbr-mcp.
...
* [CentricMem](https://github.com/zeyu-j/centricmem-skill) ⭐ 0 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-23 - Hosted librarian for agent Markdown memory via host MCP.
...
* [plori](https://github.com/plori-ai/codex-plugin) ⭐ 0 | 🐛 2 | 📅 2026-09-20 - Create and drive plori AI agents in persistent cloud environments over remote MCP, with OAuth auto-discovery and a bundled Agent Skill.
...
After scaffolding with `$plugin-creator`, use [`plugin-scanner`](https://github.com/hashgraph-online/hol-guard) ⭐ 666 | 🐛 117 | 🌐 Python | 📅 2026-09-25 as your quality gate before publishing, review, or distribution.
...
* [Astra Flash Orchestrator](https://github.com/ethanplusai/astra-flash-orchestrator) ⭐ 666 | 🐛 4 | 🌐 Python | 📅 2026-09-20 - Codex skill that keeps Astra on planning and review while DeepSeek V4.1 Flash handles implementation.
* [Tura](https://github.com/Tura-AI/tura) ⭐ 642 | 🐛 6 | 🌐 Rust | 📅 2026-09-13 - A local, open-source coding agent for developers who are tired of vague skill claims, token-saving extensions with no evidence, and agents that change a repository before understanding it.
* [awesome-ai-plugins](https://github.com/hashgraph-online/awesome-ai-plugins) ⭐ 341 | 🐛 49 | 🌐 Python | 📅 2026-09-25 - Umbrella list covering Codex, Claude Code, Gemini CLI, and MCP servers.
* [codex-patch-overlay](https://github.com/salty-flower/codex-patch-overlay) ⭐ 0 | 🐛 1 | 🌐 Nushell | 📅 2026-09-25 - Patched Codex CLI builds carrying community-requested features upstream has not merged yet (live TUI reasoning streaming, completion sound, WebP image input, timed CLI queueing). Ready-to-run macOS/Linux binaries plus a Nix overlay, refreshed each upstream release.
...
Every plugin in this list is automatically ingested by the [HOL Plugin Registry](https://hol.org/registry/plugins), which runs each through the [`plugin-scanner`](https://github.com/hashgraph-online/hol-guard) ⭐ 666 | 🐛 117 | 🌐 Python | 📅 2026-09-25 to produce a trust score and security analysis.
