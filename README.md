...
1. **Validate with [`plugin-scanner`](https://github.com/hashgraph-online/hol-guard) ⭐ 472 | 🐛 45 | 🌐 Python | 📅 2026-08-25** — **Required: score ≥ 80, no high/critical findings**
2. **Gate PRs with the [HOL scanner GitHub Action](https://github.com/hashgraph-online/ai-plugin-scanner-action) ⭐ 4 | 🐛 1 | 📅 2026-08-24** — **Required for listing**
...
* [Claude Code Skills](https://github.com/alirezarezvani/claude-skills) ⭐ 24,923 | 🐛 7 | 🌐 Python | 📅 2026-08-24 - 223 production-ready skills, 23 agents, and 298 Python tools across 9 domains — engineering, marketing, product, compliance, and more.
...
* [spec-superflow](https://github.com/MageByte-Zero/spec-superflow) ⭐ 764 | 🐛 8 | 🌐 JavaScript | 📅 2026-08-16 - Spec-first workflow with nine skills, lightweight Quick / Hotfix / Tweak / Full paths, bounded three-attempt repair loops, auditable recovery commands, hardened delta-spec sync, and guarded review gates.
...
* [Session Orchestrator](https://github.com/Kanevry/session-orchestrator) ⭐ 48 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-24 - Session orchestration for Claude Code, Codex, and Cursor IDE — structured planning, wave-based execution, VCS integration (GitLab + GitHub), quality gates, and clean session close-out with issue tracking.
...
* [Context Guard](https://github.com/GreenLv/codex-context-guard) ⭐ 3 | 🐛 1 | 🌐 Python | 📅 2026-08-25 - Preserves authoritative requirements and verification evidence across long-running Codex tasks and context compaction.
...
* [River Review](https://github.com/s977043/river-review) ⭐ 2 | 🐛 15 | 🌐 JavaScript | 📅 2026-08-25 - Versioned Skill Registry of code-review skills driven by a perspective-based review agent (code, security, performance, architecture, testing, adversarial) that verifies findings against the diff.
...
* [Education Agent Skills](https://github.com/GarethManning/education-agent-skills) ⭐ 681 | 🐛 8 | 🌐 TypeScript | 📅 2026-08-10 - 131 evidence-based education skills for curriculum design, lesson planning, and assessment, with transparent evidence ratings and MCP server.
...
* [YouTube Skills by TranscriptAPI](https://github.com/ZeroPointRepo/youtube-skills) ⭐ 560 | 🐛 3 | 📅 2026-08-23 - Twelve drop-in agent skills for YouTube transcripts, timestamped captions and subtitles, video and channel search, playlists and channel browsing through the TranscriptAPI service.
...
* [Call-E](https://github.com/CALLE-AI/call-e-integrations) ⭐ 85 | 🐛 11 | 🌐 JavaScript | 📅 2026-08-21 - Plan, run, and inspect Call-E phone call workflows from Codex through the calle CLI.
...
* [awesome-ai-plugins](https://github.com/hashgraph-online/awesome-ai-plugins) ⭐ 118 | 🐛 55 | 🌐 Python | 📅 2026-08-24 - Umbrella list covering Codex, Claude Code, Gemini CLI, and MCP servers.
