...
1. **Validate with [`plugin-scanner`](https://github.com/hashgraph-online/hol-guard) ⭐ 646 | 🐛 106 | 🌐 Python | 📅 2026-09-22**. The catalog-owned centralized scan must report a numeric score ≥ 80 before merge.
...
* [Claude Code Skills](https://github.com/alirezarezvani/claude-skills) ⭐ 26,241 | 🐛 25 | 🌐 Python | 📅 2026-08-30 - 223 production-ready skills, 23 agents, and 298 Python tools across 9 domains — engineering, marketing, product, compliance, and more.
...
* [Claude Octopus](https://github.com/nyldn/claude-octopus) ⭐ 4,092 | 🐛 6 | 🌐 Shell | 📅 2026-09-22 - Multi-LLM orchestration dispatching to 8 providers (Codex, Gemini, Copilot, Qwen, Perplexity, OpenRouter, Ollama, OpenCode) with Double Diamond workflows, adversarial review, and safety gates.
* [Stop That Shit](https://github.com/lennney/stop-that-shit) ⭐ 2,186 | 🐛 4 | 🌐 JavaScript | 📅 2026-09-21 - Local-first scope guard for Codex with explicit task modes, before-action checks, and bounded dependency, hash, and subagent decisions.
...
* [spec-superflow](https://github.com/MageByte-Zero/spec-superflow) ⭐ 810 | 🐛 6 | 🌐 JavaScript | 📅 2026-09-21 - Lean spec workflow with direct or planned execution, optional specifications, one final review by default, recoverable state, and delta spec sync.
...
* [token-optimizer](https://github.com/ooples/token-optimizer-mcp) ⭐ 531 | 🐛 15 | 🌐 JavaScript | 📅 2026-09-22 - Cut token usage 60-90% with caching, compression, and smart file tools — diff-only re-reads, paths-only search, out-of-context stashing, and a per-tool savings report for Codex and Claude Code.
...
* [AgentOps](https://github.com/boshu2/agentops) ⭐ 444 | 🐛 1 | 🌐 Go | 📅 2026-09-19 - DevOps layer for coding agents with flow, feedback, and memory that compounds between sessions.
...
* [Archcore](https://github.com/archcore-ai/plugin) ⭐ 60 | 🐛 16 | 🌐 Shell | 📅 2026-09-22 - Spec-driven development and context engineering for Claude Code, Cursor, Codex, and GitHub Copilot — backed by project context in Git.
...
* [Agent Guard](https://github.com/JeongJaeSoon/agent-guard) ⭐ 28 | 🐛 0 | 🌐 Shell | 📅 2026-09-21 - Local-by-default, no-telemetry hooks block or mask secret leaks in Claude Code and Codex, with opt-in PII filtering and Git/CI backstops.
...
* [UIZZE](https://github.com/uizze/uizze) ⭐ 22 | 🐛 5 | 🌐 JavaScript | 📅 2026-09-21 - STOP UI SLOP. Gives Codex 800,000+ real web and iOS screens, a product-specific design contract, and a hard finish gate before generic UI ships; connect it at <https://uizze.com>.
...
* [Quiver](https://github.com/yagizdo/quiver) ⭐ 13 | 🐛 1 | 🌐 Shell | 📅 2026-09-21 - 21 development lifecycle skills and 20 review and debug agents for Codex, Claude Code, Cursor, and OpenCode, where every step writes its output to disk instead of leaving it in the chat.
...
* [BABOK Analyst](https://github.com/GSkuza/BABOK_ANALYST) ⭐ 9 | 🐛 12 | 🌐 JavaScript | 📅 2026-09-22 - BABOK v3 business analysis agent with 16 MCP tools, a 9-stage pipeline, and human-in-the-loop approval gates.
...
* [Codex Process Jobs](https://github.com/joelfarthing/codex-process-jobs) ⭐ 4 | 🐛 2 | 🌐 JavaScript | 📅 2026-09-15 - Run long local builds, tests, benchmarks, and inference jobs as durable detached processes with tracked status, bounded results, and completion delivery across Codex surfaces.
...
* [River Review](https://github.com/s977043/river-review) ⭐ 3 | 🐛 36 | 🌐 JavaScript | 📅 2026-09-22 - Versioned Skill Registry of code-review skills driven by a perspective-based review agent (code, security, performance, architecture, testing, adversarial) that verifies findings against the diff.
...
* [Codex Quota Optimizer](https://github.com/ctdaniel/codex-quota-optimizer) ⭐ 2 | 🐛 0 | 🌐 Python | 📅 2026-09-22 - Reduces avoidable Codex usage with task-aware model routing, focused context, minimal change surfaces, and layered verification.
...
* [deja](https://github.com/vshulcz/deja-vu) ⭐ 920 | 🐛 20 | 🌐 Go | 📅 2026-09-22 - Search the coding sessions already on your disk — Codex, Claude Code, Cursor, opencode and nineteen more — including work from before it was installed, indexed locally with no model in the loop.
* [YouTube Skills by TranscriptAPI](https://github.com/ZeroPointRepo/youtube-skills) ⭐ 901 | 🐛 4 | 📅 2026-09-21 - Twelve drop-in agent skills for YouTube transcripts, timestamped captions and subtitles, video and channel search, playlists and channel browsing through the TranscriptAPI service.
...
* [OC ChatGPT Multi Auth](https://github.com/ndycode/oc-chatgpt-multi-auth) ⭐ 188 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-21 - Codex setup skill and OpenCode plugin for ChatGPT Plus/Pro OAuth, GPT-5/Codex presets, and multi-account failover.
...
* [X (Twitter) Skills](https://github.com/sergebulaev/x-skills) ⭐ 96 | 🐛 0 | 🌐 Python | 📅 2026-09-17 - Codex-ready X (Twitter) marketing bundle with a native .codex-plugin manifest: tweet and thread writing with corpus-validated hook formulas (validated against \~450 top tweets), AI-tell humanizer, hook extraction, reply drafting, content planning, and audience insights; also works in Claude Code.
...
* [Agent Message Queue](https://github.com/avivsinai/agent-message-queue) ⭐ 87 | 🐛 5 | 🌐 Go | 📅 2026-09-22 - File-based inter-agent messaging with co-op mode, cross-project federation, and orchestrator integrations.
...
* [Jev Social](https://github.com/socai-io/jev-social) ⭐ 46 | 🐛 6 | 🌐 JavaScript | 📅 2026-09-21 - Read-only Instagram, TikTok, and LinkedIn research in the user's local browser, with Jev selecting bounded operations and the socai CLI returning source-linked evidence and reports.
...
After scaffolding with `$plugin-creator`, use [`plugin-scanner`](https://github.com/hashgraph-online/hol-guard) ⭐ 646 | 🐛 106 | 🌐 Python | 📅 2026-09-22 as your quality gate before publishing, review, or distribution.
...
* [Tura](https://github.com/Tura-AI/tura) ⭐ 639 | 🐛 2 | 🌐 Rust | 📅 2026-09-13 - A local, open-source coding agent for developers who are tired of vague skill claims, token-saving extensions with no evidence, and agents that change a repository before understanding it.
* [awesome-ai-plugins](https://github.com/hashgraph-online/awesome-ai-plugins) ⭐ 319 | 🐛 50 | 🌐 Python | 📅 2026-09-22 - Umbrella list covering Codex, Claude Code, Gemini CLI, and MCP servers.
...
Every plugin in this list is automatically ingested by the [HOL Plugin Registry](https://hol.org/registry/plugins), which runs each through the [`plugin-scanner`](https://github.com/hashgraph-online/hol-guard) ⭐ 646 | 🐛 106 | 🌐 Python | 📅 2026-09-22 to produce a trust score and security analysis.
