...
1. **Validate with [`plugin-scanner`](https://github.com/hashgraph-online/hol-guard) ⭐ 438 | 🐛 31 | 🌐 Python | 📅 2026-08-17** — **Required: score ≥ 80, no high/critical findings**
2. **Gate PRs with the [HOL scanner GitHub Action](https://github.com/hashgraph-online/ai-plugin-scanner-action) ⭐ 3 | 🐛 1 | 📅 2026-08-16** — **Required for listing**
...
* [Claude Code Skills](https://github.com/alirezarezvani/claude-skills) ⭐ 24,538 | 🐛 35 | 🌐 Python | 📅 2026-08-17 - 223 production-ready skills, 23 agents, and 298 Python tools across 9 domains — engineering, marketing, product, compliance, and more.
* [Generative Media Skills](https://github.com/SamurAIGPT/Generative-Media-Skills) ⭐ 4,076 | 🐛 4 | 🌐 Shell | 📅 2026-08-15 - 13 skills for image, video, and audio generation using 100+ models - FLUX, Midjourney v7, Veo3, Kling 3.0, Suno, and HunyuanVideo via muapi.ai.
* [Claude Octopus](https://github.com/nyldn/claude-octopus) ⭐ 3,974 | 🐛 0 | 🌐 Shell | 📅 2026-08-16 - Multi-LLM orchestration dispatching to 8 providers (Codex, Gemini, Copilot, Qwen, Perplexity, OpenRouter, Ollama, OpenCode) with Double Diamond workflows, adversarial review, and safety gates.
* [Brooks Lint](https://github.com/hyhmrright/brooks-lint) ⭐ 1,364 | 🐛 2 | 🌐 JavaScript | 📅 2026-08-14 - AI code reviews grounded in six classic engineering books — decay risk diagnostics with book citations, severity labels, and four analysis modes (PR review, architecture audit, tech debt, test quality).
...
* [Aegis](https://github.com/GanyuanRan/Aegis) ⭐ 1,033 | 🐛 0 | 🌐 Python | 📅 2026-08-16 - An agentic skills framework & software development methodology that works: planning, TDD, debugging, and collaboration workflows.
* [spec-superflow](https://github.com/MageByte-Zero/spec-superflow) ⭐ 746 | 🐛 6 | 🌐 JavaScript | 📅 2026-08-16 - Spec-first workflow with nine skills, lightweight Quick / Hotfix / Tweak / Full paths, bounded three-attempt repair loops, auditable recovery commands, hardened delta-spec sync, and guarded review gates.
...
* [RAG Reviewer](https://github.com/mimfort/rag_for_git) ⭐ 20 | 🐛 0 | 🌐 Python | 📅 2026-08-16 - Agentic PR review: hybrid RAG + code graph via MCP, review skills for Codex.
...
* [UIZZE](https://github.com/uizze/uizze) ⭐ 5 | 🐛 1 | 🌐 JavaScript | 📅 2026-08-17 - STOP UI SLOP. Gives Codex 800,000+ real web and iOS screens, a product-specific design contract, and a hard finish gate before generic UI ships; connect it at <https://uizze.com>.
...
* [DeepSeek Mini-Router](https://github.com/hccccc01333/codex-deepseek-mini-router) ⭐ 0 | 🐛 1 | 🌐 JavaScript | 📅 2026-08-16 - Task-aware spec/react/flash working-contract plugin that fixes DeepSeek weak default reasoning inside Codex, with a measured BigCodeBench harness included.
...
* [KiCad Happy](https://github.com/aklofas/kicad-happy) ⭐ 976 | 🐛 6 | 🌐 Python | 📅 2026-08-01 - KiCad EDA skills for schematic analysis, PCB layout review, component sourcing, BOM management, and manufacturing preparation.
* [Digital Marketing Pro](https://github.com/indranilbanerjee/digital-marketing-pro) ⭐ 745 | 🐛 5 | 🌐 Python | 📅 2026-08-17 - Open-source AI marketing plugin for agencies — 154 skills, 25 specialist agents, 12-Part Strategy Flow, AEO/GEO, GSC AI Performance Report, Google Ads API v24, EU AI Act Article 50 / C2PA compliance.
* [Education Agent Skills](https://github.com/GarethManning/education-agent-skills) ⭐ 621 | 🐛 8 | 🌐 TypeScript | 📅 2026-08-10 - 131 evidence-based education skills for curriculum design, lesson planning, and assessment, with transparent evidence ratings and MCP server.
* [LinkedIn Skills](https://github.com/sergebulaev/linkedin-skills) ⭐ 560 | 🐛 0 | 🌐 Python | 📅 2026-08-09 - Codex-ready LinkedIn marketing bundle with a native .codex-plugin manifest and 10 skills: post writing with 16 tested hook formulas, AI-tell humanizer, pre-publish audit, comment and reply drafting, hook extraction, content planning, profile optimization, engager analytics, and thread monitoring; also works in Claude Code.
* [YouTube Skills by TranscriptAPI](https://github.com/ZeroPointRepo/youtube-skills) ⭐ 520 | 🐛 2 | 📅 2026-08-12 - Twelve drop-in agent skills for YouTube transcripts, timestamped captions and subtitles, video and channel search, playlists and channel browsing through the TranscriptAPI service.
* [Taisly Agent Kit](https://github.com/taisly/agent) ⭐ 256 | 🐛 1 | 🌐 JavaScript | 📅 2026-07-06 - Publish short-form videos to TikTok, Instagram Reels, YouTube Shorts, X, and Facebook from Codex with the Taisly MCP server and bundled social media posting skill.
* [ru-text](https://github.com/talkstream/ru-text) ⭐ 201 | 🐛 0 | 🌐 Shell | 📅 2026-08-15 - Russian text quality — \~1,044 rules for typography, info-style, editorial, UX writing, and business correspondence.
* [Codex Usage Tracker](https://github.com/douglasmonsky/codex-usage-tracker) ⭐ 192 | 🐛 10 | 🌐 Python | 📅 2026-08-12 - Track aggregate Codex token usage from local session logs with MCP tools for summaries, session detail, CSV export, and dashboard generation.
* [Bitbucket CLI](https://github.com/avivsinai/bitbucket-cli) ⭐ 187 | 🐛 0 | 🌐 Go | 📅 2026-08-16 - Manage Bitbucket repos, PRs, branches, issues, webhooks, and pipelines for Data Center and Cloud.
...
* [Agent Message Queue](https://github.com/avivsinai/agent-message-queue) ⭐ 82 | 🐛 2 | 🌐 Go | 📅 2026-08-16 - File-based inter-agent messaging with co-op mode, cross-project federation, and orchestrator integrations.
* [Jenkins CLI](https://github.com/avivsinai/jenkins-cli) ⭐ 81 | 🐛 5 | 🌐 Go | 📅 2026-08-17 - GitHub CLI-style interface for Jenkins controllers with jobs, pipelines, runs, logs, artifacts, credentials, and nodes.
* [Call-E](https://github.com/CALLE-AI/call-e-integrations) ⭐ 77 | 🐛 5 | 🌐 JavaScript | 📅 2026-08-17 - Plan, run, and inspect Call-E phone call workflows from Codex through the calle CLI.
...
After scaffolding with `$plugin-creator`, use [`plugin-scanner`](https://github.com/hashgraph-online/hol-guard) ⭐ 438 | 🐛 31 | 🌐 Python | 📅 2026-08-17 as your quality gate before publishing, review, or distribution.
...
* [awesome-ai-plugins](https://github.com/hashgraph-online/awesome-ai-plugins) ⭐ 95 | 🐛 20 | 🌐 Python | 📅 2026-08-16 - Umbrella list covering Codex, Claude Code, Gemini CLI, and MCP servers.
...
Every plugin in this list is automatically ingested by the [HOL Plugin Registry](https://hol.org/registry/plugins), which runs each through the [`plugin-scanner`](https://github.com/hashgraph-online/hol-guard) ⭐ 438 | 🐛 31 | 🌐 Python | 📅 2026-08-17 to produce a trust score and security analysis.
