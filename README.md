...
1. **Validate with [`plugin-scanner`](https://github.com/hashgraph-online/hol-guard) ⭐ 627 | 🐛 99 | 🌐 Python | 📅 2026-09-19**. The catalog-owned centralized scan must report a numeric score ≥ 80 before merge.
2. **Optionally gate your source repo with the [HOL scanner GitHub Action](https://github.com/hashgraph-online/ai-plugin-scanner-action) ⭐ 5 | 🐛 1 | 📅 2026-09-18**. Catalog admission uses the centralized scan; source-repo scanner CI is recommended but not required.
...
* [Claude Code Skills](https://github.com/alirezarezvani/claude-skills) ⭐ 26,135 | 🐛 18 | 🌐 Python | 📅 2026-08-30 - 223 production-ready skills, 23 agents, and 298 Python tools across 9 domains — engineering, marketing, product, compliance, and more.
* [Generative Media Skills](https://github.com/SamurAIGPT/Generative-Media-Skills) ⭐ 4,303 | 🐛 4 | 🌐 Shell | 📅 2026-09-08 - 13 skills for image, video, and audio generation using 100+ models - FLUX, Midjourney v7, Veo3, Kling 3.0, Suno, and HunyuanVideo via muapi.ai.
* [Claude Octopus](https://github.com/nyldn/claude-octopus) ⭐ 4,088 | 🐛 0 | 🌐 Shell | 📅 2026-09-19 - Multi-LLM orchestration dispatching to 8 providers (Codex, Gemini, Copilot, Qwen, Perplexity, OpenRouter, Ollama, OpenCode) with Double Diamond workflows, adversarial review, and safety gates.
* [Stop That Shit](https://github.com/lennney/stop-that-shit) ⭐ 2,095 | 🐛 4 | 🌐 JavaScript | 📅 2026-09-16 - Local-first scope guard for Codex with explicit task modes, before-action checks, and bounded dependency, hash, and subagent decisions.
...
* [Aegis](https://github.com/GanyuanRan/Aegis) ⭐ 1,211 | 🐛 1 | 🌐 Python | 📅 2026-09-16 - An agentic skills framework & software development methodology that works: planning, TDD, debugging, and collaboration workflows.
* [spec-superflow](https://github.com/MageByte-Zero/spec-superflow) ⭐ 807 | 🐛 7 | 🌐 JavaScript | 📅 2026-09-15 - Spec-first workflow with nine skills, lightweight Quick / Hotfix / Tweak / Full paths, bounded three-attempt repair loops with auditable adjudication recovery, hardened delta-spec sync, and guarded review gates.
* [Boss](https://github.com/echoVic/boss-skill) ⭐ 558 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-18 - BMAD pipeline plugin that orchestrates a full requirements-to-deploy workflow across nine specialist agents with an auditable runtime DAG and quality gates, for Claude Code, Codex, OpenClaw, and Antigravity.
* [token-optimizer](https://github.com/ooples/token-optimizer-mcp) ⭐ 530 | 🐛 4 | 🌐 JavaScript | 📅 2026-09-19 - Cut token usage 60-90% with caching, compression, and smart file tools — diff-only re-reads, paths-only search, out-of-context stashing, and a per-tool savings report for Codex and Claude Code.
...
* [Nightshift](https://github.com/orwa-mahmoud/nightshift) ⭐ 63 | 🐛 4 | 🌐 Shell | 📅 2026-09-17 - Accountable, time-bounded Codex shifts with a persistent punch list, parked decisions, and reviewable run history.
...
* [Agent Guard](https://github.com/JeongJaeSoon/agent-guard) ⭐ 28 | 🐛 6 | 🌐 Shell | 📅 2026-09-18 - Local-by-default, no-telemetry hooks block or mask secret leaks in Claude Code and Codex, with opt-in PII filtering and Git/CI backstops.
...
* [Epic Harness](https://github.com/epicsagas/epic-harness) ⭐ 19 | 🐛 8 | 🌐 Rust | 📅 2026-09-18 - Auto-trigger quality skills + self-evolving agent harness — orbit (spec-to-ship), evolve (skill mutation), team (multi-agent), TDD, check, ship, simplify, debug, perf, secure.
...
* [Magents](https://github.com/abnegate/magents) ⭐ 4 | 🐛 2 | 🌐 Rust | 📅 2026-09-19 - Shared session bus MCP + skill so Codex can list, read, hand off, send, and spawn with Claude, Cursor, Grok, and friends without pasting context.
...
* [LinkedIn Skills](https://github.com/sergebulaev/linkedin-skills) ⭐ 2,822 | 🐛 1 | 🌐 Python | 📅 2026-09-18 - Codex-ready LinkedIn marketing bundle with a native .codex-plugin manifest and 10 skills: post writing with 16 tested hook formulas, AI-tell humanizer, pre-publish audit, comment and reply drafting, hook extraction, content planning, profile optimization, engager analytics, and thread monitoring; also works in Claude Code.
* [KiCad Happy](https://github.com/aklofas/kicad-happy) ⭐ 1,256 | 🐛 2 | 🌐 Python | 📅 2026-09-13 - KiCad EDA skills for schematic analysis, PCB layout review, component sourcing, BOM management, and manufacturing preparation.
* [YouTube Skills by TranscriptAPI](https://github.com/ZeroPointRepo/youtube-skills) ⭐ 884 | 🐛 4 | 📅 2026-09-15 - Twelve drop-in agent skills for YouTube transcripts, timestamped captions and subtitles, video and channel search, playlists and channel browsing through the TranscriptAPI service.
* [deja](https://github.com/vshulcz/deja-vu) ⭐ 854 | 🐛 21 | 🌐 Go | 📅 2026-09-19 - Search the coding sessions already on your disk — Codex, Claude Code, Cursor, opencode and nineteen more — including work from before it was installed, indexed locally with no model in the loop.
...
* [Education Agent Skills](https://github.com/GarethManning/education-agent-skills) ⭐ 783 | 🐛 3 | 🌐 TypeScript | 📅 2026-08-28 - 131 evidence-based education skills for curriculum design, lesson planning, and assessment, with transparent evidence ratings and MCP server.
...
* [X Twitter Scraper](https://github.com/Xquik-dev/x-twitter-scraper) ⭐ 202 | 🐛 3 | 🌐 JavaScript | 📅 2026-09-18 - X/Twitter data, monitored workflows, HMAC webhooks, and MCP access through the Xquik REST API with confirmation-gated write guidance.
...
* [X (Twitter) Skills](https://github.com/sergebulaev/x-skills) ⭐ 86 | 🐛 0 | 🌐 Python | 📅 2026-09-17 - Codex-ready X (Twitter) marketing bundle with a native .codex-plugin manifest: tweet and thread writing with corpus-validated hook formulas (validated against \~450 top tweets), AI-tell humanizer, hook extraction, reply drafting, content planning, and audience insights; also works in Claude Code.
...
* [CentricMem](https://github.com/zeyu-j/centricmem-skill) ⭐ 1 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-17 - Hosted librarian for agent Markdown memory via host MCP.
...
* [plori](https://github.com/plori-ai/codex-plugin) ⭐ 0 | 🐛 2 | 📅 2026-09-18 - Create and drive plori AI agents in persistent cloud environments over remote MCP, with OAuth auto-discovery and a bundled Agent Skill.
...
After scaffolding with `$plugin-creator`, use [`plugin-scanner`](https://github.com/hashgraph-online/hol-guard) ⭐ 627 | 🐛 99 | 🌐 Python | 📅 2026-09-19 as your quality gate before publishing, review, or distribution.
...
* [awesome-ai-plugins](https://github.com/hashgraph-online/awesome-ai-plugins) ⭐ 291 | 🐛 64 | 🌐 Python | 📅 2026-09-19 - Umbrella list covering Codex, Claude Code, Gemini CLI, and MCP servers.
* [codex-patch-overlay](https://github.com/salty-flower/codex-patch-overlay) ⭐ 0 | 🐛 1 | 🌐 Nushell | 📅 2026-09-18 - Patched Codex CLI builds carrying community-requested features upstream has not merged yet (live TUI reasoning streaming, completion sound, WebP image input, timed CLI queueing). Ready-to-run macOS/Linux binaries plus a Nix overlay, refreshed each upstream release.
...
Every plugin in this list is automatically ingested by the [HOL Plugin Registry](https://hol.org/registry/plugins), which runs each through the [`plugin-scanner`](https://github.com/hashgraph-online/hol-guard) ⭐ 627 | 🐛 99 | 🌐 Python | 📅 2026-09-19 to produce a trust score and security analysis.
